...
from manipulate import ReducedDataset, SubDataset, TransformedDataset, permutate_image_pixels
...
def get_multitask_experiment(name, scenario, tasks, data_dir="./store/datasets", normalize=False, augment=False,
    ...
    if name == 'permMNIST':
        ...
        if not only_config:
            ...
            target_transform = None #transforms.Lambda(lambda y, p=permutation: int(p[y]))
